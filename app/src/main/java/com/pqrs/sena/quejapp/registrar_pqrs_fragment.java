...
public class registro_usuario extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtContrase̱a =(EditText) findViewById(R.id.edt_contrase̱a);

    }
    public void salvar(View view){
        // enviarDatos(edtNombreCompleto.getText().toString(), edtApellidos.getText().toString(), spnTipoDocumento.getSelectedItem().toString(), edtNumeroDocumento.getText().toString(), edtNombreUsuario.getText().toString(), edtContrase̱a.getText().toString());
        ...
        miHash.put("clave",edtContrase̱a.getText().toString());
